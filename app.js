document.getElementById("btn").onclick = function(){
    ...
    const firstDiscountValue = Number(document.getElementById("first-discount").value);
    const secondDiscountValue = Number(document.getElementById("second-discount").value);
    const thirdDiscountValue = Number(document.getElementById("third-discount").value);
    ...
    document.getElementById("first-discount-output").innerHTML = `<h2>Cabin price with ${firstDiscountValue}% discount is: ${cabinPriceDiscount}</h2>
    ...
    if (secondDiscountValue === 0) {
        ...
        document.getElementById("second-discount-output").innerHTML = `<h2>Cabin price is: ${secondCabinPrice}</h2>
    ...
    if (thirdDiscountValue === 0) {
       ...
       document.getElementById("third-discount-output").innerHTML = `<h2>Cabin price is: ${thirdCabinDiscount}</h2>
